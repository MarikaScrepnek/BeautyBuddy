...
import SubmitReviewModal from "../reviews/modals/SubmitReviewModal";
...
import { searchReviews } from "../reviews/api/reviewApi";
import { searchQuestions } from "../questions/api/qaApi";
...
export default function ProductDetails() {
  ...
  return (
    <div className="product-details-container">
        ...
        {addToRoutineOpen && (
            <AddToRoutineModal
                baseCategoryName={data.category.baseCategoryName}
                productName={data.name}
                productId={data.id}
